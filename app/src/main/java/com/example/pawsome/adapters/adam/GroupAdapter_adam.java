...
import com.example.pawsome.view.fragment.MyGroupsFragment;
...
public class GroupAdapter_adam extends RecyclerView.Adapter<GroupAdapter_adam.GroupViewHolder> {
    ...
    public GroupAdapter_adam(Fragment fragment) {
        this.filteredGroup = new HashMap<>();
        this.allGroupList = new HashMap<>();
        this.fragment = fragment;
    }

    public GroupAdapter_adam setGroupCallback(MealCallback mealCallback) {
    ...
    public void filter(boolean isChecked, String text) {
        ...
        for (Group group : allGroupList.values()) {
            if (isChecked) {
                if (true /*CurrentUser.getInstance().checkFavGame(group.getGame().getName()) && group.getName().toLowerCase().contains(text.toLowerCase())*/) {
    ...
    public class GroupViewHolder extends RecyclerView.ViewHolder {
        ...
        public GroupViewHolder(@NonNull View itemView) {
            ...
            group_BTN_join.setOnClickListener(view -> mealCallback.joinClicked(getItem(getAdapterPosition()), getAdapterPosition()));
            group_BTN_leave.setOnClickListener(view -> mealCallback.deleteClicked(getItem(getAdapterPosition()), getAdapterPosition()));
